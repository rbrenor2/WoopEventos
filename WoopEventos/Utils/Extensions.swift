...
extension UIColor {
    ...
    static let mainPurple = UIColor.rgb(red: 110, green: 0, blue: 230)
    static let lightPurple = UIColor.rgb(red: 135, green: 65, blue: 255)
    static let mainGreen = UIColor.rgb(red: 24, green: 81, blue: 19)
    static let lightGreen = UIColor.rgb(red: 0, green: 230, blue: 110)
}
